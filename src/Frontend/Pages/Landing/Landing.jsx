    ...
    <>
      <div className="h-max w-full bg-grid-white/[0.06] relative flex">
        ...
        <div className='z-20 animate-in'>
          ...
          <main className='flex w-[100vw] z-500 min-h-[550px] items-center mt-[10vh] justify-between sm:px-[5.5rem] md:px-[7rem] lg:px-[8rem]'>
            <div className=''>
              <h1 className='tex font-pop whitespace-nowrap'>THE PLACE<br />TO SHARE FUN<br />AND HUMOR</h1>
            ...
            <div className='monitor-container'>
              ...
              {/* <Monitor /> */}
              <h1 className='flex justify-center items-center h-[100%] opacity-70'>(removed monitor temporarily)</h1>
            </div>
          </main>

          <div className='mt-10 mb-36 flex w-[100vw] z-500 justify-between sm:px-[5.5rem] md:px-[6rem] lg:px-[8rem]'>
            <div className='w-[30%] flex justify-center mr-20'>
              <img src="log.png" alt="" className='flex h-[12vw] ' />
            </div>
            <div className='w-[70%] max-w-[700px]'>
              <h1 className='font-pop font-black text-6xl whitespace-nowrap'>WHAT IS BANTR?</h1>
