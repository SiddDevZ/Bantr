            ...
            <main className='h-screen w-[100vw] bg-[#1f1f1f] flex overflow-scroll'>
                ...
                <div className='w-[550px] mx-auto sm:pt-10 xss:pt-4 px-4 h-screen animate-in'>
                    ...
                    <div className='md:px-12 sm:px-10 xs:px-7 xss:px-[1vw]'>
                        <h1 className='sm:text-4xl xs:text-3xl xss:text-[1.75rem] mt-[5vh] font-pop font-semibold mb-2 whitespace-nowrap'><span className='bg-gradient-to-r from-[#ebebeb] to-[#c8c8c8] text-transparent bg-clip-text'>Welcome Back! </span>👋</h1>
